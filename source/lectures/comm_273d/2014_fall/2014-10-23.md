...
Using the [MySQL dump](http://stash.padjo.org/dumps/sql/congress_twitter.sql.zip) or [SQLite dump](http://stash.padjo.org/dumps/sql/congress_twitter.sqlite.zip) of  of Congress and Twitter data, run this query to find _every_ tweett mentioning "ebola" and selecting the relevant fields:
